                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-3 mt-4 rounded-lg text-white font-bold shadow-md hover:shadow-lg transition-all transform active:scale-95 ${loading ? 'bg-red-400 cursor-not-allowed' : 'bg-red-600 hover:bg-red-700'}`}
                        >
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-gray-600 text-sm">
                            ...
                            <Link to="/user/signup" className="text-red-600 hover:text-red-700 font-semibold hover:underline">
                                Register here
                            </Link>
                        </p>
                        <div className="mt-4 pt-4 border-t border-gray-100">
                            <Link to="/bloodbank/login" className="text-sm text-gray-400 hover:text-gray-600">
