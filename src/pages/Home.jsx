    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white flex flex-col items-center justify-center p-6 font-sans">
      <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Connecting donors, patients, and blood banks in a unified platform for
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
        {/* Blood Bank Card */}
        <div className="group relative bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-200">
          <div className="absolute top-0 left-0 w-full h-2 bg-red-600"></div>
          <div className="p-8">
            <div className="h-14 w-14 bg-red-50 rounded-2xl flex items-center justify-center mb-6 text-red-600 transition-colors duration-200">
        ...
        <div className="group relative bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-200">
          ...
          <div className="p-8">
            <div className="h-14 w-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 text-blue-600 transition-colors duration-200">
        ...
        <div className="group relative bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-200">
          ...
          <div className="p-8">
            <div className="h-14 w-14 bg-gray-50 rounded-2xl flex items-center justify-center mb-6 text-gray-700 transition-colors duration-200">
