        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                <div className="bg-red-600 p-6 text-center text-white">
                    ...
                    <p className="text-red-100 text-sm mt-1">Join the network to save lives</p>
                </div>
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-1">
                                <label className="block text-sm font-semibold text-gray-700">Blood Bank Name</label>
                                <input
                                    type="text"
                                    name="name"
                                    value={formData.name}
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-3 rounded-lg text-white font-bold shadow-md hover:shadow-lg transition-all transform active:scale-95 ${loading ? 'bg-red-400 cursor-not-allowed' : 'bg-red-600 hover:bg-red-700'}`}
                        >
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-gray-600 text-sm">
                            ...
                            <Link to="/bloodbank/login" className="text-red-600 hover:text-red-700 font-semibold hover:underline">
                                Login here
                            </Link>
                        </p>
                    </div>
