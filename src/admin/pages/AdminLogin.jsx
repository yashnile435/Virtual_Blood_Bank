    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        <div className="bg-red-600 p-6 text-center border-b border-red-500 relative">
          ...
          <p className="text-red-100 text-xs uppercase tracking-widest mt-1">
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3 mt-2 rounded-lg bg-red-600 hover:bg-red-700 text-white font-bold tracking-wide shadow-md hover:shadow-lg transition-all duration-200 ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
            >
